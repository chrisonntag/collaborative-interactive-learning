...
CIL systems can be described in many ways as \textit{organic}. In general, systems are being called organic, 
if they fulfill so-called self-x-properties\cite{Organic:schloer}\cite{Organic:schmeck}.

\subsection{Self-Configuration}
They configure themselves in the sense that they are not aligned by developers to an application case.

\subsection{Self-Optimization}
They optimize themselves by applying various strategies of ML to expand their knowledge.

\subsection{Self- Healing and Protecting}
They heal and protect themselves because cooperation with other systems is possible and desired.
