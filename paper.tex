...
\begin{itemize}
    ...
    \item \textit{Games}.
        ...
        possible moves after each turn, and therefore a realtively small game tree containing 
...
The learner constantly interacts with his environment to gain new information. For each action 
he gets a reward. His goal is to maximize his reward over several repetitions. 
...
Data points must be checked for similarity in this context in some way.
